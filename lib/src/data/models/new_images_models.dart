class NewImages {
  ...
  Urls? urls;
  Links? links;
  List<ApiImage>? categories;
  int? likes;
  bool? likedByUser;
  List<ApiImage>? currentUserCollections;
  Sponsorship? sponsorship;
  TopicSubmissions? topicSubmissions;
  Sponsor? user;

  NewImages({this.id, this.createdAt, this.updatedAt, this.promotedAt, this.width, this.height, this.color, this.blurHash, this.description, this.altDescription, this.urls, this.links, this.categories, this.likes, this.likedByUser, this.currentUserCollections, this.sponsorship, this.topicSubmissions, this.user});

  NewImages.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['categories'] != null) {
      categories = <ApiImage>[];
      json['categories'].forEach((v) { categories!.add( ApiImage.fromJson(v)); });
    }
    likes = json['likes'];
    likedByUser = json['liked_by_user'];
    if (json['current_user_collections'] != null) {
      currentUserCollections = <ApiImage>[];
      json['current_user_collections'].forEach((v) { currentUserCollections!.add( ApiImage.fromJson(v)); });
    }
...
class ImageLinks {
  ...
  ImageLinks({this.self, this.html, this.download, this.downloadLocation});
...
class ApiImage {
  ...
  ApiImage({this.id, this.createdAt, this.updatedAt, this.promotedAt, this.width, this.height, this.color, this.blurHash, this.description, this.altDescription, this.urls, this.links, this.categories, this.likes, this.likedByUser, this.currentUserCollections, this.sponsorship, this.topicSubmissions, this.user});
  ...
  ApiImage.fromJson(Map<String, dynamic> json) {
    ...
    if (json['categories'] != null) {
      categories = <ApiImage>[];
      json['categories'].forEach((v) { categories!.add(new ApiImage.fromJson(v)); });
    }
    likes = json['likes'];
    likedByUser = json['liked_by_user'];
    if (json['current_user_collections'] != null) {
